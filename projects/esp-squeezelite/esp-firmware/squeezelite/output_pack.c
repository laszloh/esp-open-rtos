...
inline s32_t gain(s32_t gain, s32_t sample) {
...
inline void _apply_cross(struct buffer *outputbuf, frames_t out_frames, s32_t cross_gain_in, s32_t cross_gain_out, s32_t **cross_ptr) {
...
inline void _apply_gain(struct buffer *outputbuf, frames_t count, s32_t gainL, s32_t gainR) {
