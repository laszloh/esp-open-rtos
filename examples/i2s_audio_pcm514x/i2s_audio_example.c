 ...
 * The example is tested with the PCM5142 16 bit DAC.
 *
 ...
 * output. 
 *
 * The PCM514x has to be connected through SPI or I2C to the ESP8266. The code
 * was tested with SPI and the CS connected to gpio 0.
 *
...
// the PCM5142 configuration

static const pcm514x_t dev = {
	.mode = HWCFG_SPI,
	.cs = 0,
	.clk.out_en = 0
};
